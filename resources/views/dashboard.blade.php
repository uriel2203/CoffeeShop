...
<body class="bg-[#ebd9c8] text-[#2c221a] font-sans antialiased h-screen overflow-hidden flex selection:bg-[#9f6a27] selection:text-white">
    ...
    <!-- SIDEBAR (LEFT)                             -->
    <!-- ========================================== -->
    <aside class="w-20 md:w-64 bg-white/60 h-full flex flex-col justify-between border-r border-[#dcc5ae] flex-shrink-0 transition-all duration-300">
        ...
        <nav class="flex-1 px-4 py-4 space-y-2">
            <!-- Menus (Active) -->
            <a href="#" class="flex items-center gap-4 px-4 py-3 bg-[#ebd9c8]/50 text-[#8c5319] rounded-xl font-medium border-r-4 border-[#8c5319]">
            ...
            <!-- Products -->
            <a href="#" class="flex items-center gap-4 px-4 py-3 text-[#5c4a3b] hover:bg-[#ebd9c8]/30 hover:text-[#8c5319] rounded-xl font-medium transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <a href="#" class="flex items-center gap-4 px-4 py-3 text-[#5c4a3b] hover:bg-[#ebd9c8]/30 hover:text-[#8c5319] rounded-xl font-medium transition-colors">
             ...
             <!-- Settings -->
             <a href="#" class="flex items-center gap-4 px-4 py-3 text-[#5c4a3b] hover:bg-[#ebd9c8]/30 hover:text-[#8c5319] rounded-xl font-medium transition-colors mt-auto">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
    ...
    <!-- ========================================== -->
    <aside class="hidden lg:flex w-80 bg-[#fdfaf6] h-full flex-col shadow-[-10px_0_20px_-10px_rgba(0,0,0,0.05)] border-l border-[#dcc5ae] flex-shrink-0 z-10 transition-all duration-300">
