        ...
        <header class="p-6 md:p-8 pb-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#ebd9c8]">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative w-full md:w-64">
                    <input type="text" placeholder="Search product..." class="w-full bg-white/70 border border-[#dcc5ae] rounded-full py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:border-[#8c5319] focus:ring-1 focus:ring-[#8c5319] placeholder:text-[#a08f80]">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-[#ebd9c8] bg-[#fcfaf8] text-xs uppercase tracking-wider text-[#8a7663]">
                            ...
                            <th class="px-6 py-4 font-bold text-center">View Details</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-[#ebd9c8] text-sm text-[#2a241f]">
                        ...
                        <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/americano/all" alt="Americano" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                                    <span class="font-bold">Americano</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[#5c4a3b]">Coffee</td>
                            <td class="px-6 py-4 font-bold">₱139.00</td>
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full border border-green-200">Available</span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="#" class="inline-flex items-center gap-1.5 text-xs font-bold text-[#8a7663] hover:text-[#8c5319] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg> View
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/cappuccino/all" alt="Cappuccino" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                        ...
                        <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/chocolate/all" alt="Dark Chocolate" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                                    <span class="font-bold">Dark Chocolate</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[#5c4a3b]">Koze Latte</td>
                            <td class="px-6 py-4 font-bold">₱139.00</td>
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full border border-green-200">Available</span>
                            </td>
                        ...
                        <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/matcha/all" alt="Matcha" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                                    <span class="font-bold">Matcha</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[#5c4a3b]">Koze Latte</td>
                            <td class="px-6 py-4 font-bold">₱149.00</td>
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full border border-green-200">Available</span>
                            </td>
                            <td class="px-6 py-4">
                        ...
                        <!-- Row 6 -->
                         <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/strawberry,drink/all" alt="Strawberry Matcha" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                                    <span class="font-bold">Strawberry Matcha</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[#5c4a3b]">Koze Latte</td>
                            <td class="px-6 py-4 font-bold">₱159.00</td>
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full border border-green-200">Available</span>
                            </td>
                            <td class="px-6 py-4">
                         ...
                         <tr class="hover:bg-[#fcfaf8]/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://loremflickr.com/100/100/greenapple/all" alt="Green Apple" class="w-10 h-10 rounded-md object-cover border border-[#ebd9c8] bg-white">
                                    <span class="font-bold">Green Apple</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[#5c4a3b]">Handmade Ade</td>
                            <td class="px-6 py-4 font-bold">₱119.00</td>
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold text-red-700 bg-red-100 px-3 py-1 rounded-full border border-red-200">Unavailable</span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <button class="p-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-sm transition-colors" title="Edit">
